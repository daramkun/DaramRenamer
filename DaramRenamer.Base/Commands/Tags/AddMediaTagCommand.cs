...
using StringType = TagLib.StringType;

namespace DaramRenamer.Commands;

[Serializable]
[LocalizationKey("Command_Name_AddMediaTag")]
public class AddMediaTagCommand : BaseCommand
{
    ...
    public override bool DoCommand(BaseFileInfo fileInfo)
    {
        ...
        try
        {
            f = File.Create(new File.LocalFileAbstraction(fileInfo.OriginalFullPath), ReadStyle.PictureLazy);
        }
        catch
        {
            return false;
