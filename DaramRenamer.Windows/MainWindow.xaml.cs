...
public partial class MainWindow : Window, INotifyPropertyChanged
{
    ...
    internal static string GetCopyrightString()
    {
        ...
        return copyrights is {Length: > 0}
            ? (copyrights[0] as AssemblyCopyrightAttribute)?.Copyright ?? string.Empty
            : string.Empty;
    }
    ...
    private void MenuEditRestoreSelected_Click(object sender, RoutedEventArgs e)
    {
        if (ListViewFiles.SelectedItems.Count == 0)
        {
            MessageBox(Strings.Instance["RestoreSelectedErrorMessage"],
                Strings.Instance["RestoreSelectedErrorMessageDetail"], TaskDialogIcon.Error,
                TaskDialogCommonButtonFlags.OK);
            return;
        }
...
EXIT";
    ...
    public static readonly RoutedCommand CommandOpenFiles = new();
    public static readonly RoutedCommand CommandClearList = new();
    public static readonly RoutedCommand CommandApplyFile = new();
    public static readonly RoutedCommand CommandUndoWorks = new();
    public static readonly RoutedCommand CommandRedoWorks = new();
    public static readonly RoutedCommand CommandUpperItem = new();
    public static readonly RoutedCommand CommandLowerItem = new();
    public static readonly RoutedCommand CommandItemsSort = new();

    public static readonly RoutedCommand CommandCustom0 = new();
    public static readonly RoutedCommand CommandCustom1 = new();
    public static readonly RoutedCommand CommandCustom2 = new();
    public static readonly RoutedCommand CommandCustom3 = new();
    public static readonly RoutedCommand CommandCustom4 = new();
    public static readonly RoutedCommand CommandCustom5 = new();
    public static readonly RoutedCommand CommandCustom6 = new();
    public static readonly RoutedCommand CommandCustom7 = new();
    public static readonly RoutedCommand CommandCustom8 = new();
    public static readonly RoutedCommand CommandCustom9 = new();
